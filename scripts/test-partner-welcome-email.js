/**
 * Script de prueba para enviar email de bienvenida a partner
 *
 * Uso:
 * node scripts/test-partner-welcome-email.js
 */
...
async function testPartnerWelcomeEmail() {
  ...
  const testData = {
    ...
    data: {
      partner_name: 'Pedro Ayala Ortiz',
      business_name: 'Laika'
    }
  };
...
// Run the test
testPartnerWelcomeEmail().catch(console.error);
