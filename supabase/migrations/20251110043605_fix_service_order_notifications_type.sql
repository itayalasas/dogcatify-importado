/*
  # Corregir Tipo de Orden en Notificaciones

  1. Problema
    - La función usaba order_type = 'service' pero el valor real es 'service_booking'
    - La función usaba order_type = 'product' pero el valor real es 'product_purchase'

  2. Solución
    - Actualizar la función para usar los valores correctos de order_type
*/
