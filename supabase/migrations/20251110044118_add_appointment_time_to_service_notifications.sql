/*
  # Agregar Hora de Cita a Notificaciones de Servicios

  1. Cambios
    - Incluir tanto la fecha como la hora en las notificaciones de reservas confirmadas
    - Formato: "Tu reserva ha sido confirmada para DD/MM/YYYY a las HH:MM AM/PM"

  2. Columnas utilizadas
    - appointment_date: fecha y hora completa
    - appointment_time: texto con la hora (si existe como respaldo)
*/
