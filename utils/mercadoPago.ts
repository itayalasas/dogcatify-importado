...
export const createMultiPartnerOrder = async (
  ...
  try {
    ...
    // Get primary partner's configuration to get commission percentage
...
export const createUnifiedPaymentPreference = async (
  ...
  try {
    ...
    // Para configuraciones OAuth - usar marketplace split automático
    ...
    if (hasValidOAuthConfig) {
      // Usar marketplace split automático con comisión configurable
